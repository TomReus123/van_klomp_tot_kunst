...
if(isset($_SESSION["user_id"])) {
    ...
    if ($user == 9) {
        ...
        echo "<h2 id='admin2'>Welkom admin</h2>";
        echo '<br>';
        //   header("location: ../?action=admin");
        echo '<a href="?action=admin" id="admin3">Naar het bedieningspaneel </a>';
        echo "</div>";
        ...
        echo '<br>';
        //   header("location: ../?action=admin");
        echo '<a href="?action=bedrijfpagina" id="admin3">Naar Pagina</a>';
        echo "</div>";
